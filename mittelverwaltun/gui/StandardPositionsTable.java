 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class StandardPositionsTable extends JTable implements ActionListener {
	
	public StandardPositionsTable(TableModelListener tml, ArrayList positions){
		PositionsTableModel model = new PositionsTableModel(positions);
