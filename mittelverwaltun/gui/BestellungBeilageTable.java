...
public class BestellungBeilageTable extends JTable {
  ...
  private Object[][] data = {{new Integer(1),"","", new Float(0),new Boolean(false), new Boolean(false), new String("Del"), new String("Show")}};
...
//		getColumnModel().getColumn(4).setCellRenderer(new TableButtonCellRenderer("Del"));
	...
	private void updateTableStructur(){
		...
		getColumnModel().getColumn(7).setCellRenderer(new TableButtonCellRenderer("Löschen"));
